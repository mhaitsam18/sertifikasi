    ...
    <div class="col-md-12">
        <nav aria-label="breadcrumb" class="float-right mt-1">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/dosen/profil">Profil</a></li>
...
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <form action="/dosen/edit/{{ $dosen->id }}" method="post" enctype="multipart/form-data" class="needs-validation">
                    <h4>Data Dosen</h4>
                    @method('put')
                    @csrf
                    <div class="form-group mb-3">
        ...
        <div class="card">
            <div class="card-body">
                <form action="/dosen/destroy/{{ auth()->user()->id }}" method="post" class="needs-validation">
                    <h4>Nonaktifkan Akun</h4>
                    @csrf
                    <div class="d-grid gap-2">
                        <button class="btn btn-danger" type="submit">Nonaktifkan Akun</button>
                    </div>
                </form>
            </div>
        </div>
