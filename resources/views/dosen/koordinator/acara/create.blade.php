                ...
                <div class="card-body">
                    ...
                    <form action="/koordinator/acara" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('periode') is-invalid @enderror" name="periode" id="periode" required placeholder="Tahun - Bulan" value="{{ old('periode') }}">
                            @error('periode')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            <label for="nama_penyelenggara">Penyelenggara<span class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('nama_penyelenggara') is-invalid @enderror" name="nama_penyelenggara" id="nama_penyelenggara" required placeholder="Nama Penyelenggara" value="{{ old('nama_penyelenggara') }}">
