                                ...
                                @foreach ($list_acara as $acara)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/dosen/fasilitas?acara_id={{ $acara->id }}" class="btn btn-soft-primary btn-sm">Kelola Fasilitas</a>
                                            <a href="/koordinator/nilai?acara_id={{ $acara->id }}" class="btn btn-soft-success btn-sm">Nilai & Sertifikat</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
