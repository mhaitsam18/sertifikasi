                ...
                <div class="card-body">
                    ...
                    <form action="/dashboard/userDosen/{{ $dosen->user->id }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_dan_gelar') is-invalid @enderror" id="nama_dan_gelar" name="nama_dan_gelar" required autofocus value="{{ old('nama_dan_gelar', $dosen->nama_dan_gelar) }}">
