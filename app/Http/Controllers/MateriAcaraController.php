...
class MateriAcaraController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/koordinator/acara/materi?acara_id=' . $request->acara_id)->with('success', 'Materi baru telah ditambahkan!');
    }
    ...
    public function update(Request $request, Materi $materi)
    {
        ...
        Materi::where('id', $materi->id)
            ->update($validateData);
        return redirect('/koordinator/acara/materi?acara_id=' . $request->acara_id)->with('success', 'Data Materi berhasil diperbarui!');
    }
